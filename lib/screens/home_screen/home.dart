...
import '../tabbar_screens/final_screen.dart';
import '../tabbar_screens/inline_screen.dart';
import '../tabbar_screens/midline_screen.dart';
import '../tabbar_screens/refinal_screen.dart';
      ...
      floatingActionButton: FloatingActionButton.small(
        onPressed: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (ctx) => DragableFormPage()));
        },
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            onPressed: () {
              Navigator.of(context)
                  .push(MaterialPageRoute(builder: (ctx) => ProgressPage()));
            },
            icon: Icon(
          ...
          IconButton(
            onPressed: () {
              Navigator.of(context)
                  .push(MaterialPageRoute(builder: (ctx) => ReassignPage()));
            },
            icon: Icon(
              Icons.assessment,
              color: Colors.grey.shade700,
